...
export default function NavbarPage() {
  ...
  const onToggle = (e) => setTheme(e.target.checked ? "dark" : "light");
  ...
  return (
    <nav className="navbar bg-base-100 shadow-sm sticky top-0 z-50">
      ...
      <div className="navbar-start">
        ...
        {/* Brand */}
        <a className="btn btn-ghost text-xl normal-case">Darma Kedai</a>
      </div>
      ...
      <div className="navbar-end gap-2">
        ...
        >
          ...
          {/* Moon (show when light -> want dark) */}
          <svg
